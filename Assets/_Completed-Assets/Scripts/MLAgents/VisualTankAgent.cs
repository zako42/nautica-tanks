...
namespace TanksML {
    /// <summary>
    /// This agent uses pure visual observations from the camera instead of numerical observation data.
    /// Meant to be an example of using visual observations and image segmentation,
    /// training an agent with this will take a long time.
    /// Feel free to experiment, but this is not meant for students to train, and we aren't going to go too much into it.
    /// </summary>
    public class VisualTankAgent : TankAgentBase
    {
